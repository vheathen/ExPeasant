defmodule PeasantWeb.TableHelpers do
  ...
  def assign_params(socket, params, sort_by, sort_dir \\ @sort_dir) do
    ...
    offset =
      try do
        params["offset"] |> String.to_integer()
      catch
        _, _ -> 0
      end
  ...
  def sort_link(socket, live_action, params, sort_by, link_name) do
    case params do
      %{sort_by: ^sort_by, sort_dir: sort_dir} ->
        ...
        |> live_patch(to: live_peasant_path(socket, live_action, [], params))
